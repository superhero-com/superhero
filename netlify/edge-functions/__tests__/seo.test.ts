/* Regression test for HARDEN-03 F1 / HARDEN-06: `injectHead` in `netlify/edge-functions/seo.ts`
...
describe('injectHead — JSON-LD script-breakout XSS regression (HARDEN-03 F1 / HARDEN-06)', () => {
