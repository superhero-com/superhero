...
// HARDEN-04 (CSP): index.html's three first-party inline <script> tags already carry a
...
// @agency/products/superhero/tasks/HARDEN-04-csp-trusted-types.md progress log). Patch the
...
// HARDEN-03 inventory (@agency/products/superhero/tasks/HARDEN-03-inventory.md): mainnet +
...
// The four sandboxed embed hosts (HARDEN-02/03): Twitter/X, YouTube, Spotify, Jitsi. Jitsi's
...
// silently short-circuited BOTH the SEO injectHead route below (HARDEN-01 — title/canonical/
