...
export default function SwapForm({ onPairSelected, onFromTokenSelected }: SwapFormProps) {
  ...
  return (
    <div className="max-w-[480px] mx-auto bg-white/[0.02] border border-white/10 backdrop-blur-[20px] rounded-[24px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.1)] relative overflow-hidden">
      {/* Header */}
