...
export default function SwapForm({ onPairSelected, onFromTokenSelected }: SwapFormProps) {
  ...
  return (
    <div className="w-full max-w-[420px] mx-auto bg-transparent border-0 p-0 relative overflow-hidden flex-shrink-0 sm:bg-white/[0.02] sm:border sm:border-white/10 sm:backdrop-blur-[20px] sm:rounded-[24px] sm:p-6 sm:shadow-[0_4px_20px_rgba(0,0,0,0.1)]">
      {/* Header */}
