...
const ConnectEthereumWallet = ({
  ...
  return (
    <Button
      ...
      disabled={disabled}
      className={`w-full py-3 sm:py-4 px-4 sm:px-6 rounded-btn border-none text-white cursor-pointer text-sm sm:text-base font-bold tracking-wider transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
        disabled
