...
export const ConnectEthereumWallet = ({
  ...
  return (
    <button
      ...
      onClick={handleConnect}
      disabled={disabled}
      className={`w-full py-3 sm:py-4 px-4 sm:px-6 rounded-2xl border-none text-white cursor-pointer text-sm sm:text-base font-bold tracking-wider uppercase transition-all duration-300 ease-in-out ${
        disabled
