...
export default function TokenSummary({
  ...
  return (
    <div
      className={`bg-white/[0.02] border border-white/10 backdrop-blur-[20px] rounded-[24px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.1)] ${className} sm:p-6 sm:bg-white/[0.02] sm:border sm:border-white/10 sm:rounded-[24px] sm:shadow-[0_4px_20px_rgba(0,0,0,0.1)] p-0 bg-transparent border-0 rounded-none shadow-none`}
    >
      {/* Header */}
      <div className="mb-6">
      ...
      {/* Token Name */}
      <div className="mb-6">
        <div className="bg-white/[0.05] border border-white/10 rounded-2xl p-4 backdrop-blur-[10px] text-center sm:p-4 sm:bg-white/[0.05] sm:border sm:border-white/10 sm:rounded-2xl sm:backdrop-blur-[10px] p-0 bg-transparent border-0">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white/[0.05] border border-white/10 rounded-2xl p-3 sm:p-4 backdrop-blur-[10px] sm:p-4 sm:bg-white/[0.05] sm:border sm:border-white/10 sm:rounded-2xl sm:backdrop-blur-[10px] p-0 bg-transparent border-0">
      ...
      <div className="flex flex-col gap-3 mb-6">
        {(token.address || token.creator_address) && (
          <div className="flex items-center gap-2 justify-between bg-white/[0.05] border border-white/10 rounded-2xl p-4 backdrop-blur-[10px] sm:p-4 sm:bg-white/[0.05] sm:border sm:border-white/10 sm:rounded-2xl sm:backdrop-blur-[10px] p-0 bg-transparent border-0">
      ...
      {/* Description */}
      <div className="text-sm text-white/60 leading-relaxed mb-6 bg-white/[0.05] border border-white/10 rounded-2xl p-4 backdrop-blur-[10px] sm:p-4 sm:bg-white/[0.05] sm:border sm:border-white/10 sm:rounded-2xl sm:backdrop-blur-[10px] p-0 bg-transparent border-0">
