...
const TX_TYPES = [
  { value: 'all', labelKey: 'dex.exploreTransactions.txTypes.all' },
  { value: 'swap_exact_tokens_for_tokens', labelKey: 'dex.exploreTransactions.txTypes.swapExactTokensForTokens' },
  { value: 'swap_tokens_for_exact_tokens', labelKey: 'dex.exploreTransactions.txTypes.swapTokensForExactTokens' },
  { value: 'swap_exact_ae_for_tokens', labelKey: 'dex.exploreTransactions.txTypes.swapExactAeForTokens' },
  { value: 'swap_exact_tokens_for_ae', labelKey: 'dex.exploreTransactions.txTypes.swapExactTokensForAe' },
  { value: 'swap_tokens_for_exact_ae', labelKey: 'dex.exploreTransactions.txTypes.swapTokensForExactAe' },
  { value: 'swap_ae_for_exact_tokens', labelKey: 'dex.exploreTransactions.txTypes.swapAeForExactTokens' },
  { value: 'add_liquidity', labelKey: 'dex.exploreTransactions.txTypes.addLiquidity' },
  { value: 'add_liquidity_ae', labelKey: 'dex.exploreTransactions.txTypes.addLiquidityAe' },
  { value: 'remove_liquidity', labelKey: 'dex.exploreTransactions.txTypes.removeLiquidity' },
  { value: 'remove_liquidity_ae', labelKey: 'dex.exploreTransactions.txTypes.removeLiquidityAe' },
];
    ...
    <div className="mx-auto md:pt-0 md:px-2 flex flex-col gap-6 md:gap-8 min-h-screen">
      <div className="grid grid-cols-1 gap-6 md:gap-8 items-start">
        ...
        <div className="liquid-glass rounded-xl p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">{t('dex.exploreTransactions.advancedFilters')}</h3>
                <p className="text-sm text-muted-foreground">{t('dex.exploreTransactions.refineSearch')}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              >
                <X className="h-4 w-4" />
                {t('common.feedRailSearch.clearAll')}
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              <div className="flex  items-center gap-2 text-sm font-medium text-foreground">
                ...
                {t('dex.exploreTransactions.transactionType')}
              </div>
              <Select
              ...
              >
                <SelectTrigger className="py-4 h-14 bg-white/[0.05] border-white/10 hover:bg-white/[0.08] transition-colors">
                  <SelectValue placeholder={t('dex.exploreTransactions.selectTransactionType')} />
                </SelectTrigger>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm font-medium text-foreground">
                ...
                {t('dex.exploreTransactions.pairAddress')}
              </div>
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input
                  placeholder={t('dex.exploreTransactions.enterPairAddress')}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm font-medium text-foreground">
                ...
                {t('dex.exploreTransactions.accountAddress')}
              </div>
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input
                  placeholder={t('dex.exploreTransactions.enterAccountAddress')}
        ...
        <DataTable
          ...
          itemsPerPage={10}
          emptyMessage={t('dex.exploreTransactions.noTransactionsMatching')}
          className="space-y-4"
        />
      </div>
    </div>
