                ...
                <div className="flex gap-2">
                  {activeAccount && (
                    <button
                      ...
                      disabled={loading}
                      className={`px-4 py-2 rounded-xl border border-white/10 bg-white/[0.02] text-white cursor-pointer text-xs font-semibold transition-all duration-300 ease-in-out backdrop-blur-[10px] flex items-center gap-2 ${loading
                    ...
                    <div className="text-center p-10 bg-white/[0.03] rounded-2xl border border-white/10 backdrop-blur-[10px]">
                      ...
                      {!activeAccount && (
                        <ConnectWalletButton
                          ...
                          variant="dex"
                          className="px-6 py-3 rounded-xl border-none bg-[#1161FE] text-white text-sm font-semibold shadow-[0_8px_25px_rgba(17,97,254,0.4)] cursor-pointer hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 ease-in-out"
                        />
                      )}
                    </div>
                  );
