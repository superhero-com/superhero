...
const PostLanguageEmptyState = ({
  ...
  return (
    <div role="status" className={`w-full py-10 flex flex-col items-center gap-3 text-center ${className}`}>
      ...
      <button
        type="button"
        onClick={onShowAll}
        className="inline-flex min-h-11 items-center justify-center rounded-full bg-[#1161FE] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#0e50d8]"
      >
