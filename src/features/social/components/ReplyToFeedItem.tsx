...
const ReplyToFeedItem = memo(({ item, onOpenPost, commentCount = 0 }: ReplyToFeedItemProps) => {
  ...
  return (
    <article
      className="relative w-[100dvw] ml-[calc(50%-50dvw)] mr-[calc(50%-50dvw)] px-3 py-3 md:w-full md:mx-0 md:p-5 bg-transparent md:bg-[var(--glass-bg)] md:border md:border-[var(--glass-border)] md:rounded-2xl md:backdrop-blur-xl transition-colors hover:border-white/25 hover:shadow-none"
      onClick={handleOpen}
      role="button"
    ...
    >
      ...
      <div className="flex gap-3 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-1 text-[10px] text-white/65 font-mono leading-[1.2] truncate">{authorAddress}</div>
