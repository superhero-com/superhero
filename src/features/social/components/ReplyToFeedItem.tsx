...
const ReplyToFeedItem = memo(({ item, onOpenPost, commentCount = 0 }: ReplyToFeedItemProps) => {
  ...
  return (
    <article
      className="relative w-[100vw] ml-[calc(50%-50vw)] mr-[calc(50%-50vw)] px-3 py-3 md:w-full md:mx-0 md:p-5 bg-transparent md:bg-[var(--glass-bg)] md:border md:border-[var(--glass-border)] md:rounded-2xl md:backdrop-blur-xl transition-colors hover:border-white/25 hover:shadow-none"
      onClick={handleOpen}
      role="button"
