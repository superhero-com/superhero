...
const TokenCreatedActivityItem = memo(({ item }: TokenCreatedActivityItemProps) => {
  ...
  return (
    <article
      ...
      className="relative w-[100dvw] ml-[calc(50%-50dvw)] mr-[calc(50%-50dvw)] px-2 py-2 md:w-full md:mx-0 md:py-3 md:px-5 bg-transparent md:bg-[var(--glass-bg)] md:border md:border-[var(--glass-border)] md:rounded-2xl md:backdrop-blur-xl transition-colors hover:border-white/25 hover:shadow-none"
