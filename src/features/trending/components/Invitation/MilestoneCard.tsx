...
export interface MilestoneStep {
  ...
  skipped?: boolean;
  info?: boolean; // For informational steps that don't affect completion status
}
            ...
            {steps.map((step, i) => (
              <div
                ...
                className={cn(
                  ...
                  step.info && 'bg-yellow-400/50',
                  !step.done && !step.skipped && !step.info && 'bg-white/[0.04] hover:bg-white/[0.06]',
                )}
              >
                <div
                  className={cn(
                    ...
                    step.info && 'bg-gray-400/50 text-white/50',
                    !step.done && !step.skipped && !step.info && 'bg-white/5 border border-white/10 text-white/50',
                  )}
                >
                  {step.info && 'ℹ'}
                  {step.done && !step.info && '✓'}
                  {!step.done && !step.info && i + 1}
                </div>
                <div
                  className={cn(
