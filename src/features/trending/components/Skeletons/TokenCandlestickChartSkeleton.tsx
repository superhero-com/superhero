    ...
    <Card className="bg-white/[0.02] border-white/10">
      <CardContent className="p-4">
        <div className="chart-skeleton relative w-full h-full">
          {/* Token Info Section */}
          <div className="token-info pr-24">
            {/* Token name row */}
            <div className="token-name-row flex items-center gap-2">
              <div className={cn(skeletonClass, 'token-name w-52 h-5')} />
              <div className={cn(skeletonClass, 'blockchain-info w-40 h-3')} />
            </div>
          ...
          {/* Chart Grid Section */}
          <div className="chart-grid relative h-[300px] flex mt-4">
            {/* Loading message */}
            {!boilerplate && (
          ...
          <div className="chart-footer flex items-center justify-between gap-4 mt-4">
            ...
            <div className="ml-auto flex items-center gap-2">
              <div className={cn(skeletonClass, 'control-primary w-28 h-[10px]')} />
              <div className={cn(skeletonClass, 'control-secondary w-14 h-[10px]')} />
              <div className={cn(skeletonClass, 'skeleton-dot w-[17px] h-[17px] rounded-full')} />
            </div>
          </div>
        </div>
      </CardContent>
