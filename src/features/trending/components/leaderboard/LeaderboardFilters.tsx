  ...
  return (
    <div className="relative">
      <button
        ...
        aria-label={t('leaderboardFilters.chooseFromCalendar', { label: label.toLowerCase() })}
      >
        <Calendar
          aria-hidden="true"
      ...
      <input
        ...
        aria-label={t('leaderboardFilters.dateInputFormat', { label })}
      />
      <input
        ref={pickerRef}
        type="datetime-local"
    ...
    <div className="w-full md:w-auto flex-1">
      <div className="flex items-center justify-between gap-2 mb-1">
        <span className="text-[11px] uppercase tracking-wide text-white/40">
          {t('leaderboardFilters.timeframe')}
        </span>
      </div>
    ...
    <div className="w-full md:w-auto md:min-w-[460px]">
      <div className="flex items-center justify-between gap-2 mb-1">
        ...
        <span className="text-[10px] text-white/30">
          {t('leaderboardFilters.dateFormatHint')}
        </span>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <DateTimeRangeInput
          label={t('leaderboardFilters.startDateLabel')}
          placeholder={t('leaderboardFilters.startPlaceholder')}
        ...
        />
        <DateTimeRangeInput
          label={t('leaderboardFilters.endDateLabel')}
          placeholder={t('leaderboardFilters.endPlaceholder')}
      ...
      <div className="w-full md:w-auto">
        ...
        >
          <SelectTrigger className="px-2 py-2 h-10 bg-white/[0.02] text-white border border-white/10 backdrop-blur-[10px] rounded-lg text-xs focus:outline-none focus:border-[#1161FE] transition-all duration-300 hover:bg-white/[0.05] w-full md:min-w-[140px]">
            <SelectValue placeholder={t('leaderboardFilters.metricPlaceholder')} />
          </SelectTrigger>
