 ...
 *
 * This is the shell described in `architecture/inline-pwa-wallet-build-plan.md`
 ...
 * zeroize) is P2+ and gated — see `architecture/inline-pwa-wallet-build-plan.md`
 * §4 and `adr-0003-wallet-key-custody.md`. Do not add mnemonic/crypto/
