/**
 * P2 slice 1 — the inner envelope (build-plan §4.1/§4.2).
 *
 ...
 *
 * Custody rules this module observes (threat-model.md / adr-0003):
 ...
 *
 * Self-describing (build-plan §4.1): the box records the `alg` and `aad` it was
