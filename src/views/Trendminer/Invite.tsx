    ...
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 w-full">
      <div className="flex flex-col items-start gap-3 min-w-[220px]">
        ...
        <div className="text-base md:text-lg text-white/80">
          {Math.max(0, total - safeDone)}
          {' '}
          steps remaining
        </div>
        <div className="flex items-center gap-3 rounded-full px-4 py-2.5 border border-white/20 bg-white/5">
          <span className="text-xl drop-shadow-[0_0_10px_rgba(255,255,255,0.35)]">🏆</span>
          <span className="text-sm uppercase tracking-wide text-white/90">Milestone reward</span>
        </div>
      </div>

      <div className="relative w-[230px] h-[230px] flex items-center justify-center lg:ml-auto">
      ...
      <div className="mx-auto px-4 py-2 space-y-8">
        ...
        <div className="grid gap-6">
          ...
          <section className="bg-black/20 backdrop-blur-lg border border-white/10 rounded-2xl p-6">
            ...
            <CircleMazeProgress total={REFERRAL_GOAL} done={referralsDone} />
