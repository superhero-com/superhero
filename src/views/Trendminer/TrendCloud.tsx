        ...
        <MobileCard variant="elevated" padding="medium" className="cloud-container">
          ...
          >
            {filteredTags.map((t) => {
              ...
              const href = token ? `/trendminer/tokens/${encodeURIComponent(token.name || token.address || t.tag)}` : `/trendminer/create?new=${encodeURIComponent(t.tag)}`;
              let text = t.tag;
      ...
      {view === 'grid' && !loading && !error && (
        <div className="grid-container">
          {filteredTags.map((t) => (
            ...
            >
              <a 
                href={tagTokenMap[t.tag] ? `/trendminer/tokens/${encodeURIComponent(tagTokenMap[t.tag].name || tagTokenMap[t.tag].address || t.tag)}` : `/trendminer/create?new=${encodeURIComponent(t.tag)}`}
                className="grid-link"
              >
        ...
        <MobileCard variant="elevated" padding="medium" className="selected-details">
          ...
          <div className="selected-actions">
            {tagTokenMap[selected.tag] ? (
              <a 
                href={`/trendminer/tokens/${encodeURIComponent(tagTokenMap[selected.tag].name || tagTokenMap[selected.tag].address || selected.tag)}`}
              ...
              <a 
                href={`/trendminer/create?new=${encodeURIComponent(selected.tag)}`}
                className="action-btn primary"
              >
                Tokenize
              </a>
